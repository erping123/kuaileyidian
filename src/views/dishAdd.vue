<template>
  <div class="klys-dish-add">
    <h1>添加菜品</h1>

    <el-form>
      <el-form-item label="菜品图片：">
        <el-upload class="klyd-uploader" :action="uploadAction" :on-success="doUploadSucc" name="dishImg" :show-file-list="false">
